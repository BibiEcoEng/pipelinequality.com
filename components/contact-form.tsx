...
export function ContactForm() {
  ...
  return (
    <>
      ...
      <div className='flex flex-col items-start gap-3 pt-2'>
        ...
        <div className='flex flex-wrap items-center gap-3'>
          ...
          <a
            ...
            className='flex items-center gap-2 border border-navy px-5 py-2.5 text-[13px] font-semibold text-navy transition-colors duration-300 hover:bg-navy hover:text-white'
          >
      ...
      {/* Disclaimer */}
      <p className='text-sm text-navy/70 text-left'>{t('disclaimer')}</p>
    </form>
